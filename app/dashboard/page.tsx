  ...
  return (
    <main className="min-h-screen bg-[#F7F7F4] px-6 py-10">
      <div className="w-full max-w-4xl mx-auto">
        ...
        {medico && !medico.registro_acess && (
          <div className="mt-5 rounded-xl px-4 py-3 text-left border border-[#FCD34D] bg-[#FFFBEB]">
            <p className="text-sm font-medium text-[#92400E]">
              Tu perfil profesional está incompleto
            </p>
            <p className="text-xs text-[#B45309] mt-0.5 mb-2">
              Agrega tu registro ACESS y SENESCYT para que aparezcan en tus notas y recetas.
            </p>
            <Link
              href="/perfil"
              className="text-xs font-medium text-[#0F766E] hover:underline focus:outline-none"
            >
              Completar perfil →
            </Link>
          </div>
        ...
        <div className="bg-white rounded-xl p-5 border border-[#E5E7EB] shadow-sm text-left">
