...
export default function CTAFinal() {
  return (
    <section className="mx-auto w-full max-w-[1400px] px-6 py-20 lg:px-12 md:py-24">
      <RevealOnScroll className="relative mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-10 overflow-hidden rounded-[2rem] border border-[var(--ln-hairline)] bg-[var(--ln-surface)] px-8 py-12 shadow-[0_8px_30px_rgba(26,26,24,0.04)] md:flex-row md:px-14 md:py-16">
        ...
        <div className="relative z-10 flex shrink-0 flex-col items-center gap-3 md:items-end">
          <Link
            href="/auth/login"
